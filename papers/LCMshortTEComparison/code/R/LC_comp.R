...
ggsave(file="~/Documents/GitHub/SpecVis/papers/LCMshortTEComparison/Figure3.pdf", pRain, width = 10, height = 10,device=cairo_pdf) #saves g
...
sink('~/Documents/GitHub/SpecVis/papers/LCMshortTEComparison/statistics.txt')
print(stData)
sink()
stData <- spvs_Statistics(dfGE,list('tNAA','tCho','Ins','Glx'))
sink('~/Documents/GitHub/SpecVis/papers/LCMshortTEComparison/GEstatistics.txt')
print(stData)
sink()
stData <- spvs_Statistics(dfPh,list('tNAA','tCho','Ins','Glx'))
sink('~/Documents/GitHub/SpecVis/papers/LCMshortTEComparison/Phstatistics.txt')
print(stData)
sink()
stData <- spvs_Statistics(dfSi,list('tNAA','tCho','Ins','Glx'))
sink('~/Documents/GitHub/SpecVis/papers/LCMshortTEComparison/Sistatistics.txt')
print(stData)
sink()
stData <- spvs_Statistics(dfQM,list('SNR','FWHM','FWHM_NAA'))
sink('~/Documents/GitHub/SpecVis/papers/LCMshortTEComparison/statistics_QM.txt')
print(stData)
sink()