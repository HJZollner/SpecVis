...
dfPhOsp <- spvs_importResults('/Volumes/Samsung/working/ISMRM/Philips/derivativesMM/MMexp40/QuantifyResults/off_tCr.csv')
dfSiOsp <- spvs_importResults('/Volumes/Samsung/working/ISMRM/Siemens/derivativesMM/MMexp40/QuantifyResults/off_tCr.csv')
dfGEOsp <- spvs_importResults('/Volumes/Samsung/working/ISMRM/GE/derivativesLMM/MMexp40/QuantifyResults/off_tCr.csv')
dataPhLCM <- spvs_importResults('/Volumes/Samsung/working/ISMRM/Philips/derivativesMM/MMexp40/LCMoutput')
dfPhLCM <- dataPhLCM[[1]]
dataSiLCM <- spvs_importResults('/Volumes/Samsung/working/ISMRM/Siemens/derivativesMM/MMexp40/LCMoutput')
dfSiLCM <- dataSiLCM[[1]]
dataGELCM <- spvs_importResults('/Volumes/Samsung/working/ISMRM/GE/derivativesLMM/MMexp40/LCMoutput')
dfGELCM <- dataGELCM[[1]]
dataPhTar <- spvs_importResults('/Volumes/Samsung/working/ISMRM/Philips/derivativesMM/MMexp40/TarquinShort')
dfPhTar <- dataPhTar[[1]]
dataSiTar <- spvs_importResults('/Volumes/Samsung/working/ISMRM/Siemens/derivativesMM/MMexp40/TarquinShort')
dfSiTar <- dataSiTar[[1]]
dataGETar <- spvs_importResults('/Volumes/Samsung/working/ISMRM/GE/derivativesLMM/MMexp40/TarquinShort')
dfGETar <- dataGETar[[1]]
...
dfGELCMbase <- read.csv('/Volumes/Samsung/working/ISMRM/GE/derivativesMM/baselineValue/GE_LCModel_baselinepMM.csv', header = TRUE,stringsAsFactors = FALSE)
dfGETarbase <- read.csv('/Volumes/Samsung/working/ISMRM/GE/derivativesMM/baselineValue/GE_Tarquin_baselinepMM.csv', header = TRUE,stringsAsFactors = FALSE)
dfGEOspbase <- read.csv('/Volumes/Samsung/working/ISMRM/GE/derivativesMM/baselineValue/GE_Osprey_baselinepMM.csv', header = TRUE,stringsAsFactors = FALSE)
dfPhLCMbase <- read.csv('/Volumes/Samsung/working/ISMRM/Philips/derivativesMM/baselineValue/Philips_LCModel_baselinepMM.csv', header = TRUE,stringsAsFactors = FALSE)
dfPhTarbase <- read.csv('/Volumes/Samsung/working/ISMRM/Philips/derivativesMM/baselineValue/Philips_Tarquin_baselinepMM.csv', header = TRUE,stringsAsFactors = FALSE)
dfPhOspbase <- read.csv('/Volumes/Samsung/working/ISMRM/Philips/derivativesMM/baselineValue/Philips_Osprey_baselinepMM.csv', header = TRUE,stringsAsFactors = FALSE)
dfSiLCMbase <- read.csv('/Volumes/Samsung/working/ISMRM/Siemens/derivativesMM/baselineValue/Siemens_LCModel_baselinepMM.csv', header = TRUE,stringsAsFactors = FALSE)
dfSiTarbase <- read.csv('/Volumes/Samsung/working/ISMRM/Siemens/derivativesMM/baselineValue/Siemens_Tarquin_baselinepMM.csv', header = TRUE,stringsAsFactors = FALSE)
dfSiOspbase <- read.csv('/Volumes/Samsung/working/ISMRM/Siemens/derivativesMM/baselineValue/Siemens_Osprey_baselinepMM.csv', header = TRUE,stringsAsFactors = FALSE)


dfSiOspbase <- dfSiOspbase[-c(5,18,20,53,54,58,68),]
...
dfGELCMCrM <- read.csv('/Volumes/Samsung_T5/working/ISMRM/GE/derivativesLCM/CrModel/GE_LCM_CrModel_woCrCH2.csv', header = TRUE,stringsAsFactors = FALSE)
dfGETarCrM <- read.csv('/Volumes/Samsung_T5/working/ISMRM/GE/derivativesLCM/CrModel/GE_Tar_CrModel_woCrCH2.csv', header = TRUE,stringsAsFactors = FALSE)
dfGEOspCrM <- read.csv('/Volumes/Samsung_T5/working/ISMRM/GE/derivativesLCM/CrModel/GE_Osp_CrModel_woCrCH2.csv', header = TRUE,stringsAsFactors = FALSE)
dfPhLCMCrM<- read.csv('/Volumes/Samsung_T5/working/ISMRM/Philips/derivativesLCM/CrModel/Philips_LCM_CrModel_woCrCH2.csv', header = TRUE,stringsAsFactors = FALSE)
dfPhTarCrM <- read.csv('/Volumes/Samsung_T5/working/ISMRM/Philips/derivativesLCM/CrModel/Philips_Tar_CrModel_woCrCH2.csv', header = TRUE,stringsAsFactors = FALSE)
dfPhOspCrM <- read.csv('/Volumes/Samsung_T5/working/ISMRM/Philips/derivativesLCM/CrModel/Philips_Osp_CrModel_woCrCH2.csv', header = TRUE,stringsAsFactors = FALSE)
dfSiLCMCrM <- read.csv('/Volumes/Samsung_T5/working/ISMRM/Siemens/derivativesLCM/CrModel/Siemens_LCM_CrModel_woCrCH2.csv', header = TRUE,stringsAsFactors = FALSE)
dfSiTarCrM <- read.csv('/Volumes/Samsung_T5/working/ISMRM/Siemens/derivativesLCM/CrModel/Siemens_Tar_CrModel_woCrCH2.csv', header = TRUE,stringsAsFactors = FALSE)
dfSiOspCrM <- read.csv('/Volumes/Samsung_T5/working/ISMRM/Siemens/derivativesLCM/CrModel/Siemens_Osp_CrModel_woCrCH2.csv', header = TRUE,stringsAsFactors = FALSE)
...
dfSiLCM <- dfSiLCM[-c(5,18,20,53,54,58,68),]
dfSiTar <- dfSiTar[-c(5,18,20,53,54,58,68),]
dfSiOsp$group<-dfSiLCM$group
dfSiOsp$`group name`<-dfSiLCM$`group name`
dfSiOsp$`age (years)`<-dfSiLCM$`age (years)`

dfQMGE <- read.csv('/Volumes/Samsung_T5/paper/Big PRESS LC comparison/MRM/GE_SNR_FWHM.csv', header = TRUE,stringsAsFactors = FALSE)
dfQMPh <- read.csv('/Volumes/Samsung_T5/paper/Big PRESS LC comparison/MRM/Ph_SNR_FWHM.csv', header = TRUE,stringsAsFactors = FALSE)
dfQMSi <- read.csv('/Volumes/Samsung_T5/paper/Big PRESS LC comparison/MRM/Si_SNR_FWHM.csv', header = TRUE,stringsAsFactors = FALSE)

dfQM <- spvs_ConcatenateDataFrame(list(dfQMGE,dfQMPh,dfQMSi),c('GE','Philips','Siemens'))

lowerLimit <- c(0.75,.05,0.35,0.75)
upperLimit <- c(2.1,0.33,1.3,2.9)
...
pGE <- spvs_RainCloud(dfGE, '/ [tCr]',list('MMexp'),c('Group'),lowerLimit,upperLimit,c(""),1)
pGE <- pGE + scale_color_manual(values = ToolColorMap)+scale_fill_manual(values = ToolColorMap)
pPh <- spvs_RainCloud(dfPh, '/ [tCr]',list('MMexp'),c('Group'),lowerLimit,upperLimit,c(""),1)
pPh <- pPh + scale_color_manual(values = ToolColorMap)+scale_fill_manual(values = ToolColorMap)
pSi <- spvs_RainCloud(dfSi, '/ [tCr]',list('MMexp'),c('Group'),lowerLimit,upperLimit,c(""),1)
pSi <- pSi + scale_color_manual(values = ToolColorMap)+scale_fill_manual(values = ToolColorMap)
pAll <- spvs_RainCloud(dfData, '/ [tCr]',list('MMexp'),c('Group'),lowerLimit,upperLimit,c(""),1)
pAll <- pAll + scale_color_manual(values = ToolColorMap)+scale_fill_manual(values = ToolColorMap)
pRain <- grid.arrange(pGE, pPh, pSi,pAll, ncol=1, nrow =4)
g <- arrangeGrob(pGE, pPh, pSi,pAll, ncol=1) #generates g
ggsave(file="RaincloudByVendorMMexp.pdf", pRain, width = 10, height = 10,device=cairo_pdf) #saves g
...
lowerLimit <- c(.2,.75,.2,.05,.2,.4,.3,.75)
upperLimit <- c(.5,2.1,.5,.33,.55,1.22,.45,2.75)


p <- spvs_Correlation(list(dfGELCM,dfPhLCM,dfSiLCM)," / [tCr]",c('bNAA','tNAA','bCho','tCho','bIns','Ins','bGlx','Glx'),c('bNAA','tNAA','bCho','tCho','bIns','Ins','bGlx','Glx'),c('GE','Philips','Siemens'),c('group name','group name','group name'),lowerLimit,upperLimit,48, 4,c(''))
p2 <- spvs_Correlation(list(dfGEOsp,dfPhOsp,dfSiOsp)," / [tCr]",c('bNAA','tNAA','bCho','tCho','bIns','Ins','bGlx','Glx'),c('bNAA','tNAA','bCho','tCho','bIns','Ins','bGlx','Glx'),c('GE','Philips','Siemens'),c('group name','group name','group name'),lowerLimit,upperLimit,48, 4,c(''))
p3 <- spvs_Correlation(list(dfGETar,dfPhTar,dfSiTar)," / [tCr]",c('bNAA','tNAA','bCho','tCho','bIns','Ins','bGlx','Glx'),c('bNAA','tNAA','bCho','tCho','bIns','Ins','bGlx','Glx'),c('GE','Philips','Siemens'),c('group name','group name','group name'),lowerLimit,upperLimit,48, 4,c(''))
p4 <- grid.arrange(p, p2, p3, ncol=1, nrow =3)
g <- arrangeGrob(p, p2, p3, ncol=1) #generates g
...
p <- spvs_Correlation(list(dfGELCM,dfPhLCM,dfSiLCM)," / [tCr]",c('MMexp','tNAA','MMexp','tCho','MMexp','Ins','MMexp','Glx'),c('MMexp','tNAA','MMexp','tCho','MMexp','Ins','MMexp','Glx'),c('GE','Philips','Siemens'),c('group name','group name','group name'),lowerLimit,upperLimit,48, 4,c(''))
p2 <- spvs_Correlation(list(dfGEOsp,dfPhOsp,dfSiOsp)," / [tCr]",c('MMexp','tNAA','MMexp','tCho','MMexp','Ins','MMexp','Glx'),c('MMexp','tNAA','MMexp','tCho','MMexp','Ins','MMexp','Glx'),c('GE','Philips','Siemens'),c('group name','group name','group name'),lowerLimit,upperLimit,48, 4,c(''))
p3 <- spvs_Correlation(list(dfGETar,dfPhTar,dfSiTar)," / [tCr]",c('MMexp','tNAA','MMexp','tCho','MMexp','Ins','MMexp','Glx'),c('MMexp','tNAA','MMexp','tCho','MMexp','Ins','MMexp','Glx'),c('GE','Philips','Siemens'),c('group name','group name','group name'),lowerLimit,upperLimit,48, 4,c(''))
p4 <- grid.arrange(p, p2, p3, ncol=1, nrow =3)
g <- arrangeGrob(p, p2, p3, ncol=1) #generates g
ggsave(file="CorrelationMMexp.pdf", p4, width = 10, height = 10,device=cairo_pdf) #saves g
